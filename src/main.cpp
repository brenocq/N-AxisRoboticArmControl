...
void display(void)
{
    ...
    glTranslatef(test1/10,-0.4,-3.0);
    glRotatef(-40, 1.0, 0.0, 0.0);

    //void gluCylinder(GLU quadric* quad, GLdouble base, GLdouble top, GLdouble height, GLint slices, GLint stacks);

    draw_cylinder(0.3, 1.0, 100, 0, 0);
